...
--
-- Host: localhost
-- Generation Time: Aug 24, 2019 at 10:39 AM
...
(1, 'James Carter', 'M', '1994-01-01', 'admin', 'street 5', '00001111', 'admin', 'admin@ubank.me', 'f31e9910ef963fb172fe8148a155eb6a67b96d89', '2019-08-24 08:49:11'),
(2, 'Bob Adams', 'M', '1996-01-01', 'admin', 'street 7', '00002222', 'bob', 'bob@ubank.me', '4ee51c0e3146c56a792f837fb30ebd21ddd873a6', '2019-08-24 08:49:24'),
(3, 'Dan Cody', 'M', '1960-02-08', 'staff', 'street 8', '00004444', 'dan', 'dan@ubank.me', 'a4b562900e7d84c3044bf91388fbc31569064c30', '2019-08-24 08:47:25');

-- --------------------------------------------------------

--
-- Table structure for table `staffclosed`
--

CREATE TABLE IF NOT EXISTS `staffclosed` (
  `id` int(5) NOT NULL,
  `name` varchar(32) NOT NULL,
  `username` varchar(20) NOT NULL,
  `account` varchar(7) NOT NULL,
...
--
-- Dumping data for table `staffclosed`
--

INSERT INTO `staffclosed` (`id`, `name`, `username`, `account`, `mobile`, `email`, `deleted`, `reason`) VALUES
(31, 'Deleted Staff', 'del.staff', 'staff', '4534346356', 'deleted@deleted.com', 'deleted', '## other ##'),
(32, 'Bob Ross', 'b.ross', 'admin', '4345452', 'bobross@mail.com', 'deleted', '## stopped ##');
...
(1, 'Adam Ronald', 'M', '2001-01-01', 'current', 'street 5', '000113', 'adam@ubank.me', '561c62b788bde046b2f0731835fe9770bb44231f', 'adam', 'United States', 'US56K', '2019-08-24 08:40:26', 'ACTIVE'),
(2, 'Henry Hart', 'M', '2002-01-01', 'savings', 'street 7', '000222', 'henry@ubank.me', 'bdb302f0856032ee1a69e129c38dce471a20b6a1', 'henry', 'United Kingdom', 'UK21C', '2019-08-24 08:46:37', 'ACTIVE');
...
--
-- Indexes for table `staffclosed`
--
ALTER TABLE `staffclosed`
  ADD PRIMARY KEY (`id`);
